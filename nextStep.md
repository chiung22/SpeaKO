...
### 서버 작업이 필요한 것 3건 (tech-debt-tracker 등록)
...
- **발음 팁 3개**(`Coach View Page` 우측)는 제목+설명 쌍인데, 우리 `practice_tips`는 문장 리스트다. 제목을 따로 뽑아야 하는지?
- 위 2번 설명 문구를 **서버가 생성**할지, 프론트가 카테고리별 고정 문구로 처리할지?
