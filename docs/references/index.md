...
- [스프링_수정목록_2026-08-17.md](스프링_수정목록_2026-08-17.md) — **스프링 담당자에게는 이 문서 하나만 보내면 됩니다.** 2026-08-17 배포 JAR을 뜯어 파일별로 어디를 고칠지 정리했습니다. 새로 붙인 기능 3개(커스텀 대본·TTS·하이라이팅)가 **존재하지 않는 엔드포인트를 부르고 있어** 실행하면 전부 404입니다.
